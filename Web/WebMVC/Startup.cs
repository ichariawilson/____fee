...
namespace Microsoft.Fee.WebMVC
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapControllerRoute("default", "{controller=Scholarship}/{action=Index}/{id?}");
    ...
    static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomMvc(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            if (configuration.GetValue<string>("IsClusterEnv") == bool.TrueString)
            {
                ...
                {
                    opts.ApplicationDiscriminator = "fee.webmvc";
                })
        ...
        public static IServiceCollection AddHttpClientServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddHttpClient<IScholarshipService, ScholarshipService>()
                   .AddDevspacesSupport();
        ...
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddOpenIdConnect(options =>
            {
                ...
                options.Scope.Add("scholarships");
                options.Scope.Add("applications");
                options.Scope.Add("applyingbasket");
                options.Scope.Add("webapplyingagg");
                options.Scope.Add("applications.signalrhub");
            });

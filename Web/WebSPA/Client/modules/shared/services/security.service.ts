...
export class SecurityService {
    ...
    constructor(private _http: HttpClient, private _router: Router, private route: ActivatedRoute, private _configurationService: ConfigurationService, private _storageService: StorageService) {
        ...
        this._configurationService.settingsLoaded$.subscribe(x => {
            this.authorityUrl = this._configurationService.serverSettings.studentidentityUrl
            this.storage.store('StudentIdentityUrl', this.authorityUrl);
        });
    ...
    public Authorize() {
        ...
        let scope = 'openid profile scholarships applications applyingbasket webapplyingagg applications.signalrhub';
    ...
    private getUserData = (): Observable<string[]> => {
        if (this.authorityUrl === '') {
            this.authorityUrl = this.storage.retrieve('StudentIdentityUrl');
        }

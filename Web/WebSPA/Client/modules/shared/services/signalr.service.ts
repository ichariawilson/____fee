...
export class SignalrService {
    ...
    private registerHandlers() {
        this._hubConnection.on('UpdatedApplicationState', (msg) => {
            console.log(`Application ${msg.applicationId} updated to ${msg.status}`);
            this.toastr.success('Updated to status: ' + msg.status, 'Application Id: ' + msg.applicationId);

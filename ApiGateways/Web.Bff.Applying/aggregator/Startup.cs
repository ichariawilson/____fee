...
using Microsoft.Fee.Web.Applying.HttpAggregator.Config;
using Microsoft.Fee.Web.Applying.HttpAggregator.Filters.Basket.API.Infrastructure.Filters;
using Microsoft.Fee.Web.Applying.HttpAggregator.Infrastructure;
...
namespace Microsoft.Fee.Web.Applying.HttpAggregator
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger().UseSwaggerUI(c =>
            {
                ...
                c.OAuthClientId("webapplyingaggswaggerui");
                c.OAuthClientSecret(string.Empty);
                c.OAuthRealm(string.Empty);
                c.OAuthAppName("Web Applying Aggregattor Swagger UI");
            });
    ...
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = "webapplyingagg";
            });
        ...
        public static IServiceCollection AddCustomMvc(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Applying Aggregator for Web Clients",
                    Version = "v1",
                    Description = "Applying Aggregator for Web Clients"
                });
                ...
                options.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows()
                    {
                        Implicit = new OpenApiOAuthFlow()
                        {
                            ...
                            {
                                { "webapplyingagg", "Web Applying Aggregator" }
                            }
                        }
                    }
                });

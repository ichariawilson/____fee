...
using Microsoft.Fee.Mobile.Scholarship.HttpAggregator.Config;
using Microsoft.Fee.Mobile.Scholarship.HttpAggregator.Filters.Basket.API.Infrastructure.Filters;
using Microsoft.OpenApi.Models;
using System;
using System.Collections.Generic;
using System.IdentityModel.Tokens.Jwt;
using ScholarshipApi;
using Microsoft.Fee.Mobile.Scholarship.HttpAggregator.Infrastructure;
using Microsoft.Fee.Mobile.Scholarship.HttpAggregator.Services;
using Microsoft.AspNetCore.Http;
using Microsoft.Extensions.Options;

namespace Microsoft.Fee.Mobile.Scholarship.HttpAggregator
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger().UseSwaggerUI(c =>
            {
                ...
                c.OAuthClientId("mobilescholarshipaggswaggerui");
                c.OAuthClientSecret(string.Empty);
                c.OAuthRealm(string.Empty);
                c.OAuthAppName("Mobile Scholarship Aggregattor Swagger UI");
            });
    ...
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddCustomMvc(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Scholarship Aggregator for Mobile Clients",
                    Version = "v1",
                    Description = "Scholarship Aggregator for Mobile Clients"
                });
                options.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows()
                    {
                        Implicit = new OpenApiOAuthFlow()
                        {
                            ...
                            {
                                { "mobilescholarshipagg", "Mobile Scholarship Aggregator" }
                            }
                        }
                    }
                });
        ...
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = "mobilescholarshipagg";
            });

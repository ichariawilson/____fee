...
namespace Applying.API.Application.Behaviors
{
    public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        private readonly ILogger<TransactionBehaviour<TRequest, TResponse>> _logger;
        private readonly ApplyingContext _dbContext;
        private readonly IApplyingIntegrationEventService _orderingIntegrationEventService;

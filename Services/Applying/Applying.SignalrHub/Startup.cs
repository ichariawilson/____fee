...
using Applying.SignalrHub.AutofacModules;
using Applying.SignalrHub.IntegrationEvents;
using Applying.SignalrHub.IntegrationEvents.EventHandling;
...
namespace Applying.SignalrHub
{
    public class Startup
    {
        ...
        private void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<ApplicationStatusChangedToSlotConfirmedIntegrationEvent, ApplicationStatusChangedToSlotConfirmedIntegrationEventHandler>();
            eventBus.Subscribe<ApplicationStatusChangedToGrantedIntegrationEvent, ApplicationStatusChangedToGrantedIntegrationEventHandler>();
            eventBus.Subscribe<ApplicationStatusChangedToCancelledIntegrationEvent, ApplicationStatusChangedToCancelledIntegrationEventHandler>();
            eventBus.Subscribe<ApplicationStatusChangedToSubmittedIntegrationEvent, ApplicationStatusChangedToSubmittedIntegrationEventHandler>();
        }
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            ...
            }).AddJwtBearer(options =>
            {
                ...
                options.Audience = "applications.signalrhub";

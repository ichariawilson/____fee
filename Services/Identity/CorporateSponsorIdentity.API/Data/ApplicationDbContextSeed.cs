...
using Microsoft.Fee.Services.CorporateSponsorIdentity.API.Extensions;
...
namespace Microsoft.Fee.Services.CorporateSponsorIdentity.API.Data
{
    public class ApplicationDbContextSeed
    {
        ...
        {
            string csvFileUsers = Path.Combine(contentRootPath, "Setup", "CorporateSponsors.csv");
            ...
            try
            {
                string[] requiredHeaders = {
                    "email", "name", "phonenumber", "username", "normalizedemail", "normalizedusername", "password"
                };
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            new ApplicationUser()
            {
                Email = "democorporatesponsor@fee.com",
                Id = Guid.NewGuid().ToString(),
                Name = "Name",
                PhoneNumber = "1234567890",
                UserName = "democorporatesponsor@fee.com",
                NormalizedEmail = "DEMOCORPORATESPONSOR@FEE.COM",
                NormalizedUserName = "DEMOCORPORATESPONSOR@FEE.COM",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };

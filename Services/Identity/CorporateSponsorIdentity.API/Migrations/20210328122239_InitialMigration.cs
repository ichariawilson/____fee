...
namespace CorporateSponsorIdentity.API.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Profile",
                columns: new[] { "Id", "EducationLevelId", "LocationId", "WebURL" },
                values: new object[] { new Guid("161092ba-6f8c-4aa6-9675-1ae77afd059e"), "PM", "010", "url.site" });

            migrationBuilder.InsertData(
                table: "Profile",
                columns: new[] { "Id", "EducationLevelId", "LocationId", "WebURL" },
                values: new object[] { new Guid("6f965634-4d93-48fb-992b-ca7500e187d5"), "UV", "014", "url.site" });

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_School_EducationLevel_EducationLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profile_EducationLevel_EducationLevelId",
                        column: x => x.EducationLevelId,
                        principalTable: "EducationLevel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HS", "PM", "001", "How in School" },
                    { "WHS", "CL", "005", "Which School" },
                    { "TIS", "UV", "005", "This School" },
                    { "THS", "VC", "008", "That School" },
                    { "WS", "SN", "013", "Where in School" }
                });

            migrationBuilder.InsertData(
                table: "Profile",
                columns: new[] { "Id", "DateofBirth", "EducationLevelId", "LocationId", "SchoolId" },
                values: new object[] { new Guid("c91c7cad-1e09-4a2a-9147-6c1e277fcfbc"), new DateTime(2005, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "PM", "010", "HS" });

            migrationBuilder.InsertData(
                table: "Profile",
                columns: new[] { "Id", "DateofBirth", "EducationLevelId", "LocationId", "SchoolId" },
                values: new object[] { new Guid("51e93a81-8ca8-49b4-9e76-285d8bbc5cdf"), new DateTime(1985, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "UV", "014", "TIS" });
